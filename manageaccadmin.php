<?php
    ...
    $select="SELECT * FROM admin WHERE admin_id=".$_SESSION['admin_id'];
    $qry=mysqli_query($conn,$select);
    $row=mysqli_fetch_assoc($qry);

    if(isset($_POST[submit]))
    {
        $sql = "UPDATE admin SET email='$_POST[email]',password='$_POST[password]' WHERE admin_id='$_SESSION[admin_id]'";
